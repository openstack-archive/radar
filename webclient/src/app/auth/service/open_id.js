 ...
 */
angular.module('db.auth').factory('OpenId',
    function ($location, $window, $log, $http, $q, StringUtil, UrlUtil,
              radarApiBase, localStorageService) {
        'use strict';

        var storageKey = 'openid_authorize_state';
        var authorizeUrl = radarApiBase + '/openid/authorize';
        var tokenUrl = radarApiBase + '/openid/token';
